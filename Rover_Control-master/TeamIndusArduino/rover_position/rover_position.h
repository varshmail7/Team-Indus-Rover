...
class positioning
{
  ...
  public:
    ...
    {
#ifdef POSITION_UNIT_TEST
      displn("Initialize POSITION X,Y,YAW,Xg,Yg");
#endif
      x = y = yaw = 0;
      x_g = y_g = 0;
    ...
    void intitialize_positioning( int MPU_addr = DEFAULT_MPU_ADDRESS , int buffer_size = DEFAULT_BUFFER_SIZE, float speed = DEFAULT_SPEED)
    {
      ...
      update_speed(speed);
#ifdef POSITION_UNIT_TEST
      displn("POSITIONING Initialization Complete");
#endif
    }
